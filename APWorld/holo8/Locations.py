...
def get_location_data(player: Optional[int], options: Optional[Holo8Options], doNormal: bool, doEveryday: bool):
    ...
    if doEveryday:
        locations += (
            ...
            Holo8Location("StartEnd", Regions.everyday, "1_5", lambda state: state.has_all({'Hololive Generation 0','Hololive Generation 2', 'HoloForce'}, player) or state.has_all({'Hoshimachi Suisei','Minato Aqua', 'Tokoyami Towa'}, player)),
